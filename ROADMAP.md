...
- [ ] **Plan de coupe vertical** déplaçable (slider profondeur) : affiche la
      tranche 2D du champ (comme la version legacy 2D) en overlay dans la scène
      3D — le meilleur des deux mondes.
...
- [ ] Iso-surface ou nuage semi-transparent de la zone de turbulence (rotor
      visible comme un "tube" violet).
- [ ] Surface d'ascendance : iso Vz > seuil réglable (ex. taux de chute de la
      Moustache 18 ≈ 1.1 m/s) → visualiser directement "où ça tient".
